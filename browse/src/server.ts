/**
 * ostack browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.ostack/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.ostack/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['ostack browse — headless browser for AI agents', '', 'Commands:'];
